...
class _HomePageState extends State<HomePage> {
  ...
  final List<TransactionModel> allTransactions = [
    ...
    TransactionModel(id: '2', title: "Freelance", amount: 22921.0, date: DateTime.now().subtract(Duration(days: 15)), category: "Work", type: TransactionType.income,),
    ...
    TransactionModel(id: '6', title: "Bike Fare", amount: 500.0, date: DateTime.now().subtract(Duration(days: 18)), category: "Travel", type: TransactionType.expense,),
  ];
